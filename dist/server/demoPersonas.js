...
exports.pickRandomDemoPersona = pickRandomDemoPersona;
...
function pickRandomDemoPersona() {
    return exports.DEMO_PERSONAS[Math.floor(Math.random() * exports.DEMO_PERSONAS.length)];
}
