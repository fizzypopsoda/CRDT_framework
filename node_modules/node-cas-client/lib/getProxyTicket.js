 ...
 * @returns {*}
 */
module.exports = function(req, proxyOptions, callback) {
  ...
  function requestPT(path, callback, retryHandler) {
    ...
    utils.getRequest(path, function(err, response) {
      ...
      if (pt) {
        ...
        return callback(new Error('Request for PT succeed, but the response from CAS service is invalid, response: ' + response.body));
      }
    });
  }
};
